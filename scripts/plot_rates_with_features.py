...
@click.option("--bin-size", type=float, default=5.)
...
def main(config_path, spike_events_path, spike_events_namespace, populations, arena_id, trajectory_id, target_input_features_path, target_input_features_namespace, include_artificial, max_units, t_variable, t_max, t_min, threshold, bin_size, meansub, graph_type, progress, fig_size, font_size, save_format, verbose):
