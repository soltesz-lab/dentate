...
def main(config_path, spike_events_path, spike_events_namespace, populations, include_artificial, max_units, t_variable, t_max, t_min, threshold, bin_size, meansub, graph_type, progress, fig_size, font_size, save_format, verbose):
    ...
    plot.plot_spike_rates (spike_events_path, spike_events_namespace, config_path=config_path, include=populations,
                           ...
                           saveFig=True, figFormat=save_format, progress=progress, include_artificial=include_artificial)
