...
def main(spike_events_path, spike_events_namespace, max_spikes, spike_hist_bin, t_max, t_min, font_size, overlay, verbose):
    if t_max is None:
        timeRange = None
    else:
        if t_min is None:
    ...
    plot.plot_rate_PSD (spike_events_path, spike_events_namespace, timeRange=timeRange, 
