import os, sys, os.path, itertools
import numpy as np
import click
from mpi4py import MPI  # Must come before importing NEURON
from neuron import h
from dentate import cells, neuron_utils, utils
...
def passive_test (tree, v_init):
    ...
    cell = cells.make_neurotree_cell (getattr(h,"HIPPCell"), neurotree_dict=tree)
    h.dt = 0.025
...
def main(template_path,forest_path):
    ...
    popName = "HC"
    (trees,_) = read_tree_selection (forest_path, popName, [1030000])
