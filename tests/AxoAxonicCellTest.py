...
def passive_test (tree, v_init):
    ...
    cell = utils.new_cell ("AxoAxonicCell", neurotree_dict=tree)
    h.dt = 0.025
...
def gap_junction_test (tree, v_init):
    ...
    cell1 = utils.new_cell ("AxoAxonicCell", neurotree_dict=tree)
    cell2 = utils.new_cell ("AxoAxonicCell", neurotree_dict=tree)
