TITLE Code taken from ichan2.mod  
 
COMMENT
Based on code taken from the ModelDB repository at: 
...
PARAMETER {
        ...
        ? pat added default values for these, based on soma of granule cell...
        
        enat (mV)
        gnatbar = 0.12 (mho/cm2)   
        ekf (mV)
        gkfbar = 0.016 (mho/cm2)
        eks (mV)
        gksbar = 0.006 (mho/cm2)
        gl = 0.00004 (mho/cm2)    
        el (mV)
}
