...
@click.option("--celltypes-filename", default="celltypes.json")
@click.option("--connectivity-filename", default="connectivity.json")
@click.option("--gapjunctions-filename", default="gapjunctions.json")
