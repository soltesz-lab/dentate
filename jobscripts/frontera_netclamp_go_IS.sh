...
#SBATCH -J netclamp_go_IS # Job name
#SBATCH -o ./results/netclamp_go_IS.o%j       # Name of stdout output file
#SBATCH -e ./results/netclamp_go_IS.e%j       # Name of stderr error file
...
ibrun -n 1  python3 network_clamp.py go  -c Network_Clamp_GC_Exc_Sat_SLN_IN_PR.yaml \
    -p IS -g 1050400 -t 9500 --n-trials 1 --use-coreneuron --dt 0.01 \
    ...
    --params-path $SCRATCH/dentate/results/netclamp/network_clamp.optimize.IS_20210906_110322_NOS29663979.yaml
