...
ibrun -np 768 python ./scripts/generate_distance_connections.py \
       ...
       --forest-path=$SCRATCH/dentate/DGC_forest_syns_20171019_compressed.h5 \
       --connectivity-path=$SCRATCH/dentate/DG_GC_connections_20171022.h5 \
       --connectivity-namespace=Connections \
       --coords-path=$SCRATCH/dentate/dentate_Full_Scale_Control_coords_20171005.h5 \
       --coords-namespace=Coordinates \
       --io-size=128 --cache-size=1 --value-chunk-size=20000 --chunk-size=2000 --quick
