...
### set the job name
#PBS -N dentate_Full_Scale_GC_Exc_Sat_LNN_HDiag
...
results_path=./results/Full_Scale_GC_Exc_Sat_LNN_Diag_$PBS_JOBID
export results_path
...
aprun -n 32768 -b -- bwpy-environ -- \
    ...
    --config-file=Full_Scale_GC_Exc_Sat_LNN_HDiag.yaml  \
