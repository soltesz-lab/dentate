...
### set the job name
#PBS -N dentate_Full_Scale_IncreasedGCtoMC.6
...
results_path=./results/Full_Scale_IncreasedGCtoMC.6_$PBS_JOBID
export results_path
...
runhoc="./jobscripts/bluewaters_Full_Scale_IncreasedGCtoMC_run.6_${PBS_JOBID}.hoc"

sed -e "s/JOB_ID/$PBS_JOBID/g" ./jobscripts/bluewaters_Full_Scale_IncreasedGCtoMC_run.6.hoc > $runhoc
