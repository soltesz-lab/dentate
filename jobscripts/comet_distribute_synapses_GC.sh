...
`which python3` ./scripts/distribute_synapse_locs.py \
    ...
    --forest-path=$SCRATCH/dentate/Full_Scale_Control/DGC_forest_normalized_20200628_compressed.h5 \
    --output-path=$SCRATCH/dentate/Full_Scale_Control/DGC_forest_syns_20200628.h5 \
