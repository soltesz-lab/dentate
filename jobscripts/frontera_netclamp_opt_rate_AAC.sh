...
#SBATCH -A BIR20001
#SBATCH -J netclamp_opt_rate_AAC
#SBATCH -o ./results/netclamp_opt_rate_AAC.%j.o
...
ibrun -n 12  python3 network_clamp.py optimize -c Network_Clamp_GC_Exc_Sat_SynExp3NMDA2_SLN_IN_PR.yaml \
    -p AAC -g $1 --t-max 9500 --n-trials 1 --trial-regime mean \
    ...
    --config-prefix config  --opt-iter 2000  --opt-epsilon 0.5 --use-coreneuron --dt 0.025 \
    --param-config-name "$2" \
