...
#SBATCH -J netclamp_opt_pf_MC_rate_0_all # Job name
#SBATCH -o ./results/netclamp_opt_pf_MC_rate_0_all.o%j       # Name of stdout output file
#SBATCH -e ./results/netclamp_opt_pf_MC_rate_0_all.e%j       # Name of stderr error file
...
ibrun -n 2 python3 network_clamp.py optimize  -c Network_Clamp_MC_SLN.yaml \
