...
#PBS -e ./results/compute_arc_distances.$PBS_JOBID.err
#PBS -o ./results/compute_arc_distances.$PBS_JOBID.out
#PBS -N compute_arc_distances
...
aprun -n 128 python ./scripts/compute_arc_distance.py \
