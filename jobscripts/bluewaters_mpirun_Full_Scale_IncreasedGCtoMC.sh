...
### set the job name
#PBS -N dentate_Full_Scale_IncreasedGCtoMC
...
results_path=./results/Full_Scale_IncreasedGCtoMC_$PBS_JOBID
export results_path
...
runhoc="./jobscripts/bluewaters_Full_Scale_IncreasedGCtoMC_run_${PBS_JOBID}.hoc"

sed -e "s/JOB_ID/$PBS_JOBID/g" ./jobscripts/bluewaters_Full_Scale_IncreasedGCtoMC_run.hoc > $runhoc
