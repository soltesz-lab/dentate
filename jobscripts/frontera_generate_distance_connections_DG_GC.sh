...
export PYTHONPATH=$SCRATCH/model:$NEURONROOT/lib/python:$SCRATCH/site-packages/intel19:$PYTHONPATH
...
ibrun python3 ./scripts/generate_distance_connections.py \
    ...
    --forest-path=$DATA_PREFIX/Full_Scale_Control/DGC_forest_syns_20221020_compressed.h5 \
    --connectivity-path=$DATA_PREFIX/Full_Scale_Control/DG_GC_connections_20221020.h5 \
