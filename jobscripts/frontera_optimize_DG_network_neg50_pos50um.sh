...
#SBATCH -J optimize_DG_network_neg50_pos50um # Job name
#SBATCH -o ./results/optimize_DG_network_neg50_pos50um.o%j       # Name of stdout output file
#SBATCH -e ./results/optimize_DG_network_neg50_pos50um.e%j       # Name of stderr error file
...
mpirun -rr -n 56 \
    ...
    --config-path=$DG_HOME/config/DG_optimize_network_neg50_pos50um.yaml \
    --optimize-file-dir=$results_path \
    --optimize-file-name='dmosopt.optimize_network_neg50_pos50um_20210129.h5' \
