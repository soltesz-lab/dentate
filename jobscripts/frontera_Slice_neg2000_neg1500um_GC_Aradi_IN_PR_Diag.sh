...
#SBATCH -J dentate_Slice_neg2000_neg1500um_GC_Aradi_Sat_SLN_IN_PR_Diag # Job name
...
results_path=$SCRATCH/dentate/results/Slice_neg2000_neg1500um_GC_Aradi_SLN_IN_PR_Diag_$SLURM_JOB_ID
export results_path
