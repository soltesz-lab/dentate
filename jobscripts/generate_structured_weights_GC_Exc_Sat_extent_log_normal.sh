...
mpirun -np 24 python3 ./scripts/generate_structured_weights_as_cell_attr.py \
    ...
    --initial-weights-path=$DATA_PREFIX/Slice/dentatenet_Full_Scale_GC_Exc_Sat_SLN_extent_arena_margin_20201216.h5 \
    --non-structured-weights-path=$DATA_PREFIX/Slice/dentatenet_Full_Scale_GC_Exc_Sat_SLN_extent_arena_margin_20201216.h5 \
    --non-structured-weights-namespace="Normal Weights" \
    --output-weights-path=$DATA_PREFIX/Slice/dentatenet_Full_Scale_GC_Exc_Sat_SLN_extent_arena_margin_20201216.h5 \
    --output-features-path=$DATA_PREFIX/Slice/dentatenet_Full_Scale_GC_Exc_Sat_SLN_extent_arena_margin_20201216.h5 \
    --connections-path=$DATA_PREFIX/Slice/dentatenet_Full_Scale_GC_Exc_Sat_SLN_extent_arena_margin_20201216.h5 \
    ...
    --io-size=8 --value-chunk-size=100000 --chunk-size=20000 --write-size=1 \
