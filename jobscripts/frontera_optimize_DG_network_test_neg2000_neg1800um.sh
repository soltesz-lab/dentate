...
#SBATCH -J optimize_DG_network_test_neg2000_neg1800um # Job name
#SBATCH -o ./results/optimize_DG_network_test_neg2000_neg1800um.o%j       # Name of stdout output file
#SBATCH -e ./results/optimize_DG_network_test_neg2000_neg1800um.e%j       # Name of stderr error file
