...
#SBATCH -J dentate_Slice_neg2000_neg1900um_GC_Exc_Sat_SLN_IN_PR_Diag # Job name
...
results_path=$SCRATCH/dentate/results/Slice_neg2000_neg1900um_GC_Exc_Sat_SLN_IN_PR_Diag_$SLURM_JOB_ID
export results_path
...
ibrun env PYTHONPATH=$PYTHONPATH python3 ./scripts/main.py  \
    ...
    --spike-input-path="$DATA_PREFIX/Slice/dentatenet_Slice_SLN_neg2000_neg1900um_20221210_compressed.h5" \
