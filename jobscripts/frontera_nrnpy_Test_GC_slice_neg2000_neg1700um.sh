#!/bin/bash
#
#SBATCH -J dentate_Test_GC_slice_neg2000_neg1700um
#SBATCH -o ./results/dentate_Test_GC_slice_neg2000_neg1700um.%j.o
#SBATCH --nodes=16
...
results_path=$SCRATCH/striped/dentate/results/Test_GC_slice_neg2000_neg1700um_$SLURM_JOB_ID
export results_path
...
ibrun python3 ./scripts/main.py  \
    ...
    --config-file=Test_Slice_neg2000_neg1700um_IN_Izh.yaml \
