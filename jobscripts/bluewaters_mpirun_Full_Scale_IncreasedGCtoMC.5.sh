...
### set the job name
#PBS -N dentate_Full_Scale_IncreasedGCtoMC.5
...
results_path=./results/Full_Scale_IncreasedGCtoMC.5_$PBS_JOBID
export results_path
...
runhoc="./jobscripts/bluewaters_Full_Scale_IncreasedGCtoMC_run.5_${PBS_JOBID}.hoc"

sed -e "s/JOB_ID/$PBS_JOBID/g" ./jobscripts/bluewaters_Full_Scale_IncreasedGCtoMC_run.5.hoc > $runhoc
