...
#SBATCH -J dentate_Full_Scale_GC_Exc_Sat_LNN_DiagU5 # Job name
...
results_path=./results/Full_Scale_GC_Exc_Sat_LNN_DiagU5_$SLURM_JOB_ID
export results_path
...
ibrun python2.7 ./scripts/main.py  \
    --config-file=Full_Scale_GC_Exc_Sat_LNN_DiagU5.yaml  \
