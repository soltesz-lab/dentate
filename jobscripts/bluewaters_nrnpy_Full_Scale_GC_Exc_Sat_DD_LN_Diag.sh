...
### set the job name
#PBS -N dentate_Full_Scale_GC_Exc_Sat_DD_LN_Diag
...
results_path=./results/Full_Scale_GC_Exc_Sat_DD_LN_Diag_$PBS_JOBID
export results_path
...
aprun -n 32768 -N 16 -d 2 -b -- bwpy-environ -- \
    ...
    --config-file=Full_Scale_GC_Exc_Sat_DD_LN.yaml  \
