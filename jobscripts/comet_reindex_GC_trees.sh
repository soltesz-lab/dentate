...
ibrun -np 384 python3.5 ./scripts/reindex_trees.py \
    ...
    --output-path=$SCRATCH/dentate/Full_Scale_Control/DGC_forest_reindex_20190717.h5 \
    --index-path=$SCRATCH/dentate/Full_Scale_Control/dentate_GC_coords_20190717.h5 \
    --io-size=48 -v
