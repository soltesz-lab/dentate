...
#PBS -l nodes=272:ppn=16:xe
### which queue to use
#PBS -q high
### set the wallclock time
#PBS -l walltime=3:30:00
### set the job name
#PBS -N dentate_Full_Scale_Control_Beining2017
...
git --git-dir=../dgc/.git ls-files | grep Beining2107 | tar -C ../dgc -zcf ${results_path}/dgc.tgz --files-from=/dev/stdin
...
aprun -n 4352 -b -- bwpy-environ -- \
    python2.7 main.py  \
    --config-file=config/Full_Scale_Control.yaml  \
    --template-paths=../dgc/Beining2017 \
