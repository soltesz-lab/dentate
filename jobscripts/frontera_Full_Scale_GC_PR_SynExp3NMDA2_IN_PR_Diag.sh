...
#SBATCH -J dentate_Full_Scale_GC_PR_SynExp3NMDA2_IN_PR_Diag # Job name
...
results_path=$SCRATCH/dentate/results/Full_Scale_GC_PR_SynExp3NMDA2_IN_PR_Diag_$SLURM_JOB_ID
export results_path
...
ibrun env PYTHONPATH=$PYTHONPATH $PYTHON ./scripts/main.py  \
    --config-file=Full_Scale_GC_PR_SynExp3NMDA2_IN_PR.yaml  \
