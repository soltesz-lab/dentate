...
ibrun python3 -m nested.optimize  \
    ...
    --use_coreneuron \
    --hotstart \
    --storage-file-path='results/optimize_DG_test_network_subworlds_2135192/dentatenet_results_DG_optimize_network_subworlds_0_20201203_2058.h5' \
    -v
