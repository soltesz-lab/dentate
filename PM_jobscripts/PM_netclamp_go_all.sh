...
ibrun -n 1 ./jobscripts/PM_netclamp_go_EIM_000_AAC.sh    $ACyaml 2>&1 | tee $logdirexpfx'AAC'$ext  &
ibrun -n 1 ./jobscripts/PM_netclamp_go_EIM_000_BC.sh     $BCyaml 2>&1 | tee $logdirexpfx'BC'$ext  &
ibrun -n 1 ./jobscripts/PM_netclamp_go_EIM_000_HICAP.sh  $HCyaml 2>&1 | tee $logdirexpfx'HICAP'$ext  &
ibrun -n 1 ./jobscripts/PM_netclamp_go_EIM_000_HIPP.sh   $HPyaml 2>&1 | tee $logdirexpfx'HIPP'$ext  &
ibrun -n 1 ./jobscripts/PM_netclamp_go_EIM_000_IS.sh     $ISyaml 2>&1 | tee $logdirexpfx'IS'$ext  &
ibrun -n 1 ./jobscripts/PM_netclamp_go_EIM_000_MOPP.sh   $MOyaml 2>&1 | tee $logdirexpfx'MOPP'$ext  &
ibrun -n 1 ./jobscripts/PM_netclamp_go_EIM_000_NGFC.sh   $NGyaml 2>&1 | tee $logdirexpfx'NGFC'$ext  
